...
public class VoidMethodPractice {
    public static void main(String[] args) {
        int[] a1 = {100,-200,300,50,40,79,700,0,1,2};
        arrayMaxNum(a1);
        arrayMinNum(a1);
        ...
        int[] a3 = {1,1,2,3,3,4,5,5,5,5,5,6,6,6,7};
    ...
    public static void arrayMaxNum(int[] arr){
       /* Commented out to get solution without sort, solution found with for each loop
        Arrays.sort(arr);
    ...
    public static void arrayUniqueElements(int[] arr){
        ...
        System.out.println(); // new print statement appends a new line
    }
