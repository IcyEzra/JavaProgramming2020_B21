...
public final class iPhone extends Phone{ // since iPhone will not be extended by another class, it can be final

    // created using alt ins keys and choosing constructor
